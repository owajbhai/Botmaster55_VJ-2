...
EXTRA_CHANNEL = [-1002222660530, -1002082665507]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002110806325') # give your force subscribe channel id here else leave it blank
